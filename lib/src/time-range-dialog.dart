...
class _TimeRangePickerState extends State<TimeRangePicker>
  ...
  void initState() {
    ...
    var endTime = widget.end ??
        startTime.replacing(hour: startTime.hour < 21 ? startTime.hour + 3 : startTime.hour - 21);
    ...
    if (widget.disabledTime != null) {
      _disabledStartAngle = timeToAngle(widget.disabledTime!.startTime, _offsetRad);
  ...
  void _panUpdate(PointerMoveEvent ev) {
    ...
    if (_activeTime == ActiveTime.Start) {
      ...
      if (widget.disabledTime != null) {
        ...
        var disabledAngleSigned = signedAngle(_disabledEndAngle!, _disabledStartAngle!);
        var disabledDiff =
            disabledAngleSigned < 0 ? 2 * pi + disabledAngleSigned : disabledAngleSigned;
  ...
  Widget buildTimeRange(
          {required MaterialLocalizations localizations, required ThemeData themeData}) =>
      RawGestureDetector(
            ...
            child: Center(
              child: CustomPaint(
                ...
                painter: ClockPainter(
                    ...
                    labelStyle: widget.labelStyle ?? themeData.textTheme.bodyMedium,
  ...
  Widget buildHeader(bool landscape) {
    ...
    Color backgroundColor = widget.headerBackgroundColor ?? themeData.colorScheme.primary;
      ...
      child: Flex(
        ...
        children: [
            ...
            children: [
              ...
              Text(
                MaterialLocalizations.of(context)
                    .formatTimeOfDay(_startTime, alwaysUse24HourFormat: widget.use24HourFormat),
                style: _activeTime == ActiveTime.Start
                    ? widget.activeTimeTextStyle ??
                        TextStyle(color: onPrimary, fontSize: 28, fontWeight: FontWeight.bold)
          ...
          Column(children: [
            ...
            Text(
              MaterialLocalizations.of(context)
                  .formatTimeOfDay(_endTime, alwaysUse24HourFormat: widget.use24HourFormat),
